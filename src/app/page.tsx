    ...
    <main className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-b from-blue-500 to-indigo-900 text-white">
      <div className="container flex flex-col items-center justify-center gap-12 px-4 py-16">
        ...
        <p className="text-xl text-center max-w-2xl">
          World-class RACI (Responsible, Accountable, Consulted, Informed) matrix application with
          real-time collaboration, advanced analytics, and workflow automation.
        </p>
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:gap-8">
          ...
          <div className="flex max-w-xs flex-col gap-4 rounded-xl bg-white/10 p-4 hover:bg-white/20">
            ...
            <div className="text-lg">Multiple users editing simultaneously with live updates</div>
          </div>
          <div className="flex max-w-xs flex-col gap-4 rounded-xl bg-white/10 p-4 hover:bg-white/20">
