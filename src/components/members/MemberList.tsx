...
export function MemberList({ organizationId }: MemberListProps) {
  ...
  const { data: members, isLoading, refetch } = api.member.listByOrganization.useQuery({
    organizationId,
  });
              ...
              return (
                <TableRow key={member.id}>
                  ...
                  <TableCell>
                    <Badge
                      variant={
                        roleBadgeVariant[member.role as keyof typeof roleBadgeVariant]
                      }
                  ...
                  <TableCell>
                    <Badge
                      variant={
                        statusBadgeVariant[
                          member.status as keyof typeof statusBadgeVariant
                        ]
                      }
                    >
                      {member.status}
